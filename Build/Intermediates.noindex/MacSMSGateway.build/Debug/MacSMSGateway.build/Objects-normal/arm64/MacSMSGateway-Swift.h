...
#ifndef MACSMSGATEWAY_SWIFT_H
#define MACSMSGATEWAY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MacSMSGateway",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13MacSMSGateway10BLEManager")
...
@class NSString;
@class NSNumber;
@interface BLEManager (SWIFT_EXTENSION(MacSMSGateway)) <CBCentralManagerDelegate>
...
@interface BLEManager (SWIFT_EXTENSION(MacSMSGateway)) <CBPeripheralDelegate>
